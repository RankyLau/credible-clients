...
provided, there is no column that contain NA value.
Then I turn to inspect the label of the training data, which I discover that the number of default and not default is unbalanced.


Hence I decided to use a tree-based model to solve the above problem.
